...
from .VmmCanvasGrid import VMMCanvasGrid
...
class MasterWindowClass(Tk): #overarching Tkinter window class to hold both frames
    ...
    def createCanvas(self, canvasType): #function to create the canvas
        ...
        match canvasType:
            ...
            case 'vmm_test':
                self.canvas = VMMCanvasGrid(self.ModeCanvasFrame)
    ...
    def initMenuBar(self):
        ...
        self.modeMenu.add_command(label="VMM Testing", command=lambda: self.createCanvas('vmm_test'))
